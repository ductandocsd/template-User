                ...
                <Row>
                    <Col>
                        <div className={'d-flex justify-content-between align-items-center'} style={{ marginTop: '20px'}}>
                            <h1 style={{ paddingLeft: '40px'}} className='heading-h1 mt-2 mb-2' >Trang Phục Thời Thượng  </h1>
                        </div>
                    </Col>
                </Row>
                <Row>
                                    ...
                                    <div style={{ width: '80%',margin: '25px auto'}}>
                                        ...
                                        <div className={'d-flex justify-content-between align-items-center'}>
                                            ...
                                            <Button className={'btn btn-primary'}>
                                                <Link style={{ color: '#fff'}} to={`/them-moi-ao-quan/${item.id}/dress`} className='nav-item'>Order</Link>
                                            </Button>
                                        </div>
                                    </div>
                                </Col>
